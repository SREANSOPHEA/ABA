...
<body class="w-100 vh-100 d-flex justify-content-center align-items-center">
    <div class="back d-flex gap-4 align-items-center">
        ...
        <h3>Withdraw USD Account</h3>
    </div>
    <div class="row w-100">
        <div class="col-md-5" style="margin: auto">
            <div class="box w-100 p-3">
                <h3 class="text-center">Form</h3>
                <form action="/ABA/withdraw/khr/submit" method="post">
                @csrf
                <table class="w-100">
                    <tr>
                        <th>User ID:</th>
                    ...
                    <tr>
                        <th>Account:</th>
                        <td><input type="text" class="form-control border-2 border-dark" value="KHR Account" readonly></td>
                    </tr>
                    <tr>
                        <th>Amount:</th>
                        <td><input type="number" name="amount" class="form-control border-2 border-dark" autocomplete="off"></td>
                    </tr>
                    <tr>
                        <th>Note:</th>
                    ...
                    <tr>
                        <td colspan="2" class="text-center"><button class="btn btn-primary">Withdraw</button></td>
                    </tr>
                </table>
                </form>
            </div>
